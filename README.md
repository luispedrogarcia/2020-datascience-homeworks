...
```bash
git clone https://github.com/datascience-course/2020-datascience-homeworks
```

This will create a folder `2020-datascience-homeworks` on your computer, with the individual homeworks in subdirectories.

## Updating

As we release new homeworks, or if we discover mistakes and update an already released homework description,  you'll have to update your repository. You can do this by changing into the `2020-datascience-homeworks` directory and executing:
